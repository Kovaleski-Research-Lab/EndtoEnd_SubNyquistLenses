...
def run(params):
    ...
    checkpoint_path = os.path.join(pm.path_root, model.checkpoint_path, pm.model_id)
    ...
    # Dump config
    yaml.dump(params, open(os.path.join(pm.path_root, f'{pm.path_results}/{pm.model_name}/{pm.model_id}/params.yaml'), 'w'))
